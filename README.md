...
- [ ] bouncing_star, one of these instruments is out of tune or something
- [ ] Dropping pumpkin: Mind initial position, ensure it's not inside a wall. Also, should be easier to drop off an edge.
